...
class Timesheet implements EntityWithMetaFields, ExportableItem, ModifiedAt
{
     ...
     */
    #[ORM\Column(name: 'jira_ids', type: 'text', nullable: true)]
    #[Serializer\Expose]
    #[Serializer\Groups(['Default'])]
    ...
    #[ORM\Column(type: 'string', length: 20, nullable: true)]
    #[Assert\Choice(choices: ['office', 'home'], message: 'Choose a valid location.')]
    #[Serializer\Expose]
    #[Serializer\Groups(['Default'])]
    ...
    public function setWorkPlace(?string $place): self
    {
